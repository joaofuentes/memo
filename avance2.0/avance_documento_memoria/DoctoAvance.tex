...
\input{include/historia}
%	Investigación que permite la elección de las tecnologías (hasta ahora php(apache) rails(ruby) nodejs/express(js) django(python))

% Investigación de las arquitecturas más utilizadas, SOA, cliente servidor, mvc, N tier..., incluir terminos y justificar pq se usa 3-tier
\input{include/arquitectura}

% Criterio de seleccion
\input{include/criterio}

%Evaluación
%	Preparación de ambiente de desarrollo
%	Posibles errores y como solucionarlos
\input{include/evaluacion}
